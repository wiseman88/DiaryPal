<div class="mb-4 p-4 bg-white">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
      ...
      <div>
          ...
          <input class="w-full rounded border p-2 focus:outline-none focus:shadow-outline focus:border-blue-300" type="text" wire:model.debounce.lazy="animal_number">
      ...
      <div>
          ...
          <select class="w-full focus:outline-none border p-2 rounded" wire:model.debounce.lazy="sex">
              <option value=""></option>
      ...
      <div>
          ...
          <input class="w-full rounded border p-2 focus:outline-none focus:shadow-outline focus:border-blue-300" type="date" placeholder="Cislo zvierata" wire:model.debounce.lazy="date_of_birth">
      ...
      <div>
          ...
          <input class="w-full rounded border p-2 focus:outline-none focus:shadow-outline focus:border-blue-300" type="text" wire:model.debounce.lazy="mother_number">
      ...
      <div>
          ...
          <select class="w-full focus:outline-none border p-2 rounded" wire:model.debounce.lazy="father_number">
              <option value=""></option>
      ...
      <div>
          ...
          <select class="w-full focus:outline-none border p-2 rounded" wire:model.debounce.lazy="breed">
              <option value=""></option>
      ...
      <div>
          ...
          <select class="w-full focus:outline-none border p-2 rounded" wire:model.debounce.lazy="color">
              <option value=""></option>
      ...
      <div>
          ...
          <select class="w-full focus:outline-none border p-2 rounded" wire:model.debounce.lazy="calving_technician">
              <option value=""></option>
      ...
      <div>
          ...
          <input class="w-full rounded border p-2 focus:outline-none focus:shadow-outline focus:border-blue-300" type="text" wire:model.debounce.lazy="calving_weight">
  ...
  <div class="flex">
      <button class="mr-4 mt-4 btn btn-primary" wire:click.prevent="updateAnimal">
          upravit
      </button>
      <button class="mt-4 btn btn-success" wire:click.prevent="createAnimal">
          pridat nove zviera
      </button>
  </div>
</div>